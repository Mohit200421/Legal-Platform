...
export default function LawyerDiscussion() {
  ...
  const sendReply = async () => {
    if (!replyText.trim()) return toast.error("Type message first");
        ...
        <div className="border-b border-gray-200 p-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-lg font-bold text-gray-900">Client Discussions</h2>
            </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="space-y-2 mb-2">
                      <div className="flex items-center text-xs text-gray-600">
                        ...
                        <span className="truncate">{d.userId?.name || "N/A"}</span>
                      </div>
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                Select a discussion from the sidebar to start chatting with your client
              </p>
            </div>
          </div>
        ) : (
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  {selected.status !== "resolved" && (
                    <button
                      onClick={resolveDiscussion}
                      className="px-3 py-1.5 border border-green-300 text-green-700 hover:bg-green-50 flex items-center space-x-1 text-sm"
                    >
              ...
              {selected.messages?.length === 0 ? (
                ...
                <div className="space-y-4">
                  {selected.messages.map((message, index) => {
                    const isLawyer = message.senderRole === "lawyer";
                    ...
                    return (
                      <div key={index}>
                        ...
                        <div className={`flex ${isLawyer ? 'justify-end' : 'justify-start'}`}>
                          <div className={`max-w-[70%] ${isLawyer ? 'order-2' : 'order-1'}`}>
